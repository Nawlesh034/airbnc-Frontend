...
return(
    <div className="mt-10 gap-8  grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2">
      {places.length>0 && places.map(place=>(
           ...
           <Link to={'/places/'+place._id}> 
            ...
            {place.addPhoto?.[0] && (// this places is different end point youtuber set this place
                <img className="aspect-square object-cover rounded-2xl" src={'http://localhost:4000/uploads/'+place.addPhoto?.[0] }alt=""/>
            )}
